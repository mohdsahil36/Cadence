...
const loginThemeBoot = `(function(){try{if(location.pathname.indexOf("/login")!==0)return;var s=localStorage.getItem("nocta-theme");var h=new Date().getHours();var dark=s==="dark"||(s!=="light"&&(h>=17||h<7));var c=dark?"#14131a":"#f3eee6";document.documentElement.classList.toggle("dark",dark);document.documentElement.style.backgroundColor=c;var b=document.body;if(b)b.style.backgroundColor=c;}catch(e){}})();`;
